...
/*
- code involving steps that can run at same time w/results of some steps coming later
...
axios.get("https://httpbin.org/get")
    .then(function(response)        //  .then() is the promise
    {
    // now I have some data
});
...
/* Async / Await */
/*
- functions are marked as asynchronous w/keyword 'async'
- network requests can have return values stored directly using keyword 'await' before promise
*/
...
// Multiple requests
//  each promise 'await's until ready
